...
/// [MyReorderableListView.buildDefaultDragHandles].
///
/// All list items must have a key.
///
/// This example demonstrates using the [MyReorderableListView.proxyDecorator] callback
/// to customize the appearance of a list item while it's being dragged.
///
/// {@tool dartpad}
/// While a drag is underway, the widget returned by the [MyReorderableListView.proxyDecorator]
/// callback serves as a "proxy" (a substitute) for the item in the list. The proxy is
/// created with the original list item as its child. The [MyReorderableListView.proxyDecorator]
...
/// {@end-tool}
///
/// This example demonstrates using the [MyReorderableListView.proxyDecorator] callback to
...
/// its elevation. This example demonstrates how to use the [MyReorderableListView.proxyDecorator]
...
class MyReorderableListView extends StatefulWidget {
  ...
  /// created in advance, or all at once when the [MyReorderableListView] itself
  /// is created, it is more efficient to use the [MyReorderableListView]
  ...
  /// See also:
  ///
  ///   * [MyReorderableListView], which allows you to build a reorderable
  ///     list with all the items passed into the constructor.
  const MyReorderableListView.builder({
    super.key,
